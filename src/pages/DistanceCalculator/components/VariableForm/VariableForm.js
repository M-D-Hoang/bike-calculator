...
export function VariableForm({ submitVariables }) {
    ...
    const handleSubmit = (e) => {
        ...
        const variables1 = {
            distance: Number(data.get('distance1')),
            deceleration: Number(data.get('deceleration1')),
        ...
        const variables2 = {
            distance: Number(data.get('distance2')),
            deceleration: Number(data.get('deceleration2')),
        ...
        <div className={styles.formContainer}>
            <form onSubmit={handleSubmit} onReset={() => formRef.current.requestSubmit()} ref={formRef}>
                ...
                <div className={styles.row}>
                    <label>
                        Distance (m):
                        <input type="number" name="distance1" defaultValue={1000} required min={0} />
                    </label>
                    <label>
                        Distance (m):
                        <input type="number" name="distance2" defaultValue={1000} required min={0} />
                    </label>
                </div>
                <div className={styles.row}>
                    <label>
                        Braking:
                        <select name="deceleration1">
                            <option value="0" selected>No</option>
                            <option value="1">Light (1m/s^2)</option>
                            <option value="2">Medium (2m/s^2)</option>
                            <option value="4">Heavy (4m/s^2)</option>
                        </select>
                    </label>
                    <label>
                        Braking:
                        <select name="deceleration2">
                            <option value="0" selected>No</option>
                            <option value="1">Light (1m/s^2)</option>
                            <option value="2">Medium (2m/s^2)</option>
                            <option value="4">Heavy (4m/s^2)</option>
